...
<body>
    ...
    <div class="container">
        ...
        <form action="php/editar.php?idEditar=<?php echo $Fila["id"]?>" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="DescripcionTelefono" value="<?php echo $Fila['precio']?>">
        </div>
